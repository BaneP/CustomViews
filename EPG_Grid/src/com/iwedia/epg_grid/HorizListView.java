        ...
        public void onScroll(AbsHListView view, int firstVisibleItem,
            ...
            if (getAdapter() != null) {
                if (getAdapter() instanceof HorizontalListInterface) {
                    ...
                    int leftOffset = 0;
                    HorizontalListInterface horizAdapter = ((HorizontalListInterface) getAdapter());
    ...
    public int getTotalOffsetForChildAt(int position) {
        if (getAdapter() instanceof HorizontalListInterface) {
            ...
            for (int i = 0; i < position; i++) {
                topOffset += horizAdapter.getElementWidth(i);
            }
            return topOffset;
        } else {
            throw new RuntimeException(
            ...
            if (getAdapter() instanceof HorizontalListInterface) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (widthSum <= leftOffset + totalLeftOffset
                            && widthSum + elementWidth >= totalLeftOffset
